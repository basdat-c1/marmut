...
urlpatterns = [
    ...
    path('play/<uuid:id>/add-to-playlist-success/', add_song_to_playlist_success, name='add_song_to_playlist_success'),
    path('play/<uuid:id>/download/', download_song, name='download_song'),
